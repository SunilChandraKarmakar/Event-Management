        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeshTypeId = table.Column<int>(type: "int", nullable: false),
                    IsSouthIndiaThali = table.Column<bool>(type: "bit", nullable: false),
                    IsNorthIndianThali = table.Column<bool>(type: "bit", nullable: false),
                    IsPunjabThali = table.Column<bool>(type: "bit", nullable: false),
                    IsMaharashtrianThali = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Foods_DishTypes_DishTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EnevtTypeId = table.Column<int>(type: "int", nullable: false),
